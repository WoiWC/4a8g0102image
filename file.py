...
from cv2 import imread,cvtColor,COLOR_BGR2RGB,COLOR_RGB2BGR
...
def show_img(window,img,color_space = COLOR_BGR2RGB):
    ...
    window.mainloop()
def move_img(window,img,color_space = COLOR_BGR2RGB):
    global loaded_img
    global panel
    global current_show_img
...
def read_file(window,menu = ""):
    ...
    try:
        load_img = imread(filedialog.askopenfilename())
